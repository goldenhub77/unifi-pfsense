...
# FreeBSD package list source:
FREEBSD_PACKAGE_LIST_SOURCE="https://pkg.freebsd.org/${ABI}/latest/"

# FreeBSD package list:
FREEBSD_PACKAGE_LIST_URL="${FREEBSD_PACKAGE_LIST_SOURCE}packagesite.pkg"
